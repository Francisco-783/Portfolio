  ...
  return (
    <section className={style.main} id='start'>
      <div>
        ...
        <h1>Developer</h1>
        <Link href="https://www.linkedin.com/in/francisco-insaurralde-539109220/" target="_blank">
          <Image src="/assets/s.png" width={40} height={40} alt="linkedin logo" />
        </Link>
        <Link href="https://github.com/Francisco-783" target="_blank">
          <Image src="/assets/githublogo.png" width={40} height={40} alt="github logo" />
        </Link>
        <Link href="https://docs.google.com/document/d/1ViMk0WmajaRF0nIQ2Y_ySL-GSsQLbKA6JKXVkVlstEw/edit" target="_blank">
